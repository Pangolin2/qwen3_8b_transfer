...
MERGED_CKPT="${MERGED_CKPT:-${ROOT_DIR}/output_qwen3_8b_lora_stage1/merged/merged_lora.ckpt}"
OUTPUT_FILE="${OUTPUT_FILE:-${ROOT_DIR}/stage1_eval_merged_result.json}"
